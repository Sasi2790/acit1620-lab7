...
export function getCheckbox() {
    ...
    return document.getElementById('tries-checkbox');
}
...
export function setCard() {
    ...
    const idx = Math.floor(Math.random()*9); //floor will round down
    ...
    getCardNode().parentNode.classList.toggle('flip', false)
}
...
export function showCard() {
    ...
    getShowBtn().toggleAttribute('disabled', true); //setAttribute
    // animate the card
